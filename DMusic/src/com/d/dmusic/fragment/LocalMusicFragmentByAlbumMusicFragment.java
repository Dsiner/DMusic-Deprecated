 ...
 * 
 * */
public class LocalMusicFragmentByAlbumMusicFragment extends Fragment implements OnClickListener {
	...
	public LocalMusicFragmentByAlbumMusicFragment(String album) {
