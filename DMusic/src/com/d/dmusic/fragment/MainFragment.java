...
public class MainFragment extends Fragment implements OnClickListener {
	...
	private TextView tvTitleTitle;// 标题
	private ImageView ivTitleSearch;// 搜索
	private ImageView ivTitleMainMore;// 更多
	public static FragmentManager fragmentManager;
	private LinearLayout loacl_music;// 本地音乐
	private LinearLayout colletion_music;// 我的收藏
	private SwipeMenuListView lvCustomList;// 自定义音乐列表
