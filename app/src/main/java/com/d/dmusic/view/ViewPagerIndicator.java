...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 底边的最大宽度
     */
    private final int DIMENSION_TRIANGLE_WIDTH_MAX = (int) (getScreenWidth() / 3);
    ...
    private static final int COLOR_TEXT_HIGHLIGHT = 0xff4AC221;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(Color.parseColor("#ffFD8D22"));
    ...
    private void initTriangle() {
        ...
        mTriangleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics());
        mPath = new Path();
        mPath.moveTo(0, 0);
