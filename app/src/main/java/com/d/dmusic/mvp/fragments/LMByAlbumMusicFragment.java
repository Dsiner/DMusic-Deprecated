...
import com.d.dmusic.mvp.presenters.LMByAlbumMusicPresenter;
...
public class LMByAlbumMusicFragment extends BaseFragment<LMByAlbumMusicPresenter> implements MvpView, OnClickListener {
    ...
    LinearLayout llTitleMoreBlank;
    View vTitleMoreBlank;
    LinearLayout llTitleMoreSortByName;
    LinearLayout llTitleMoreSortByTime;
    LinearLayout llTitleMoreScan;
    View dialogView;
    ...
    private CircleDialog circleDialog;// progress

    public LMByAlbumMusicFragment(String album) {
    ...
    @Override
    public LMByAlbumMusicPresenter getPresenter() {
        return new LMByAlbumMusicPresenter(this.getActivity().getApplicationContext());
    }
    ...
    public void onResume() {
        ...
        if (isLoad == false) {
            ...
            circleDialog.show();
            mPresenter.refresh(musicListModels, album, handler);
            isLoad = true;
        }
