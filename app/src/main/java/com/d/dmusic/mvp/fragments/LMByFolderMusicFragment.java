...
import com.d.dmusic.mvp.presenters.LMByFolderMusicPresenter;
...
public class LMByFolderMusicFragment extends BaseFragment<LMByFolderMusicPresenter> implements MvpView, OnClickListener {
    ...
    public LMByFolderMusicFragment(String folder) {
    ...
    @Override
    public LMByFolderMusicPresenter getPresenter() {
        return new LMByFolderMusicPresenter(this.getActivity().getApplicationContext());
    }
    ...
    public void onResume() {
        ...
        if (isLoad == false) {
            ...
            circleDialog.show();
            mPresenter.refresh(musicListModels, folder, handler);
            isLoad = true;
        }
