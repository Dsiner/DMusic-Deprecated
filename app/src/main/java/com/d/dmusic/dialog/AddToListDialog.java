...
public class AddToListDialog {
     ...
     */
    public AddToListDialog(Context context, int index, List<MusicListModel> musicListModels) {
    ...
    private void initDialog() {
        dialog = new PopFromButtomDialog(context);
        initDialogView();
    ...
    private void initDialogView() {
        ...
        addToListAdapter = new AddToListAdapter(context, R.layout.dialog_add_to_list_sub, customMusicListModels);
